				...
				<form action="<?php echo URLROOT ?>/users/register" 
					...
					<div class="form-group">
						...
						<input type="text" id="name" name="name"
							 class="form-control form-control-lg <?php echo (!empty($data['name_err'])) 
					...
					<div class="form-group">
						...
						<input type="password" id="confirm-password" name="confirm_password"
							 class="form-control form-control-lg <?php echo (!empty($data['confirm_password_err'])) 
					...
					<div class="row">
						...
						<div class="col">
							<a href="<?php URLROOT; ?>/users/login" class="btn btn-light btn-block">Have an acoount ? Login </a>
						</div>
					</div>
